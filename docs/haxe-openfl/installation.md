...
The current version of [Feathers UI](/) for Haxe and OpenFL is [**1.0.0-beta.5**](https://github.com/feathersui/feathersui-openfl/blob/v1.0.0-beta.5/CHANGELOG.md). It may be installed [from Haxelib](https://lib.haxe.org/p/feathersui).
