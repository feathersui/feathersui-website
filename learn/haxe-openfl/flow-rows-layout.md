...
Set the container's [`layout`](https://api.feathersui.com/current/feathers/controls/LayoutGroup.html#layout) property to a new [`FlowRowsLayout`](https://api.feathersui.com/current/feathers/layout/FlowRowsLayout.html) instance.
