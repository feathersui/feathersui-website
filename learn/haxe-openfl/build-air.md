...
## Configure SDK version in _project.xml_

The Adobe AIR SDK version should be specified in your OpenFL [_project.xml_ file](https://lime.openfl.org/docs/project-files/xml-format/). This value is used to populate the namespace string in the Adobe AIR application descriptor XML file generated by OpenFL.

```xml
<config:air sdk-version="51.1"/>
<!-- populates: xmlns="http://ns.adobe.com/air/application/51.1" -->
```
