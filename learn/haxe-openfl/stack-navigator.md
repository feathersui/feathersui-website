...
- [Sample: StackNavigator Data Passing Between Views](https://github.com/feathersui/feathersui-openfl/tree/v{% include "feathersui-openfl-version.html" %}/samples/stack-navigator-pass-data-between-views/)
- [Sample: StackNavigator Save and Restore Data](https://github.com/feathersui/feathersui-openfl/tree/v{% include "feathersui-openfl-version.html" %}/samples/stack-navigator-save-and-restore/)