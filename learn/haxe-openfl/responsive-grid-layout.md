...
Set the container's [`layout`](https://api.feathersui.com/current/feathers/controls/LayoutGroup.html#layout) property to a new [`ResponsiveGridLayout`](https://api.feathersui.com/current/feathers/layout/ResponsiveGridLayout.html) instance.
