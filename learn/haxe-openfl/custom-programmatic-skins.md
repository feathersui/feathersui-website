...
> The code below is based on the [custom-programmatic-skin sample project](https://feathersui.com/samples/haxe-openfl/custom-programmatic-skin/). Full [source code](https://github.com/feathersui/feathersui-openfl/tree/v1.3.0/samples/custom-programmatic-skin) for this sample is available on Github.
...
- [Sample: Custom Programmatic Skin](https://github.com/feathersui/feathersui-openfl/tree/v1.3.0/samples/custom-programmatic-skin)
- [Sample: Custom Programmatic Skin with States](https://github.com/feathersui/feathersui-openfl/tree/v1.3.0/samples/custom-programmatic-skin-with-states)
- [Sample: Animated Skin with Tween](https://github.com/feathersui/feathersui-openfl/tree/v1.3.0/samples/animated-tween-skin)