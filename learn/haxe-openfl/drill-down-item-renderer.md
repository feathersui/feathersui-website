---
title: How to use the DrillDownItemRenderer component
layout: "docs.html"
sidebarTitle: DrillDownItemRenderer
---

The [`DrillDownItemRenderer`](https://api.feathersui.com/unstable/feathers/controls/dataRenderers/DrillDownItemRenderer.html) class is designed to render items in a _data container_, such as [`Menu`](./menu.md) or [`ListView`](./list-view.md).

<!-- <figure>
<iframe src="/learn/haxe-openfl/samples/drill-down-item-renderer.html" width="100%" height="150"></iframe>
<figcaption>Live preview of the <a href="https://api.feathersui.com/unstable/feathers/controls/dataRenderers/DrillDownItemRenderer.html"><code>DrillDownItemRenderer</code></a> component</figcaption>
</figure> -->
...
The [`ToggleButtonState`](https://api.feathersui.com/current/feathers/controls/ToggleButtonState.html) enum defines the states available to all item renderer components because the [`DrillDownItemRenderer`](https://api.feathersui.com/current/feathers/controls/dataRenderers/DrillDownItemRenderer.html) class is a subclass of [`ToggleButton`](./toggle-button.md).
...
A number of styles may be customized on an [`DrillDownItemRenderer`](https://api.feathersui.com/current/feathers/controls/dataRenderers/DrillDownItemRenderer.html) component, including the font styles, the background skin, and an optional icon. Several more styles may be used to adjust the layout of the item renderer's children.
...
An optional drill-down icon may be displayed to indicate whether the item renderer represents a branch or not.

```haxe
var drillDownIcon = new TriangleSkin();
drillDownIcon.fill = SolidColor(0x333333);
drillDownIcon.border = None;
drillDownIcon.pointPosition = RIGHT;
drillDownIcon.width = 12.0;
drillDownIcon.height = 12.0;
itemRenderer.drillDownIcon = drillDownIcon;
```

This icon will be displayed if the item renderer's [`branch`](https://api.feathersui.com/unstable/feathers/controls/dataRenderers/DrillDownItemRenderer.html#branch) property is `true`, and hidden when the value is `false`.

## Related Links

- [`feathers.controls.dataRenderers.DrillDownItemRenderer` API Documentation](https://api.feathersui.com/unstable/feathers/controls/dataRenderers/DrillDownItemRenderer.html)
