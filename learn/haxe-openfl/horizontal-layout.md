...
> To see a live demonstration of percentage sizing with [`HorizontalLayout`](https://api.feathersui.com/current/feathers/layout/HorizontalLayout.html), open the [_horizontal-layout-percentage-sizing_ sample](https://feathersui.com/samples/haxe-openfl/horizontal-layout-percentage-sizing/) in your web browser. ([Source Code](https://github.com/feathersui/feathersui-openfl/tree/v1.3.0/samples/horizontal-layout-percentage-sizing/))
...
- [Sample: Percentage Sizing](https://github.com/feathersui/feathersui-openfl/tree/v1.3.0/samples/horizontal-layout-percentage-sizing/)