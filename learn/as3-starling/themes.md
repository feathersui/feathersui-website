...
> To see the difference between these two styles, you can view the `GroupedList` in the [Components Explorer sample](/samples/as3-starling/). In the settings screen for the `GroupedList`, change the "Group Style" to "inset".
