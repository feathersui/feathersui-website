...
| --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BitmapFontTextRenderer.snapToPixels`         | Use the [`pixelSnapping`](/api-reference/feathers/controls/text/BitmapFontTextRenderer.html#pixelSnapping) property instead, which is also the name of the new property on `starling.display.Mesh`.                   |
...
| `TextBlockTextRenderer.snapToPixels`          | Use the [`pixelSnapping`](/api-reference/feathers/controls/text/TextBlockTextRenderer.html#pixelSnapping) property instead, which is also the name of the new property on `starling.display.Mesh`.                    |
| `TextFieldTextRenderer.snapToPixels`          | Use the [`pixelSnapping`](/api-reference/feathers/controls/text/TextFieldTextRenderer.html#pixelSnapping) property instead, which is also the name of the new property on `starling.display.Mesh`.                    |
