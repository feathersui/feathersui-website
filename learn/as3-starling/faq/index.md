...
To quickly get up and running with some sample skins, you may want to use a [theme](../themes.md). Take a look at [Getting Started with Feathers](../getting-started.md) to see how to instantiate an example theme to help you get started. It's only one line of code.
