/*!
  Highlight.js v11.11.1 (git: 13c164fffb)
...
return n?Number(n):(e=>F.includes(e.toLowerCase()))(e)?0:1}const j={},P=e=>{
console.error(e)},K=(e,...n)=>{console.log("WARN: "+e,...n)},H=(e,n)=>{
j[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),j[`${e}/${n}`]=!0)
},q=Error();function G(e,n,{key:t}){let a=0;const i=e[t],s={},r={}
...
;[D,L,Z,$].forEach((e=>e(s,r))),e.compilerExtensions.forEach((e=>e(s,r))),
s.__beforeBegin=null,[R,I,B].forEach((e=>e(s,r))),s.isCompiled=!0;let c=null
...
const a=w.classNameAliases[e[t]]||e[t],i=n[t];a?g(i,a):(S=i,l(),S=""),t++}}
function b(e,n){
...
return 0===O.matcher.regexIndex?(S+=e[0],1):(R=!0,0)}function h(e){
const n=e[0],a=t.substring(e.index),i=m(O,e,a);if(!i)return Y;const s=O
;O.endScope&&O.endScope._wrap?(d(),
g(n,O.endScope._wrap)):O.endScope&&O.endScope._multi?(d(),
u(O.endScope,e)):s.skip?S+=n:(s.returnEnd||s.excludeEnd||(S+=n),
...
let y={};function N(a,s){const o=s&&s[0];if(S+=a,null==o)return d(),0
...
;for(const n of s)if(n&&(n(e,i),i.isMatchIgnored))return _(t)
;return a.skip?S+=t:(a.excludeBegin&&(S+=t),
d(),a.returnBegin||a.excludeBegin||(S=t)),b(a,e),a.returnBegin?0:t.length})(s)
;if("illegal"===s.type&&!i){
const e=Error('Illegal lexeme "'+o+'" for mode "'+(O.scope||"<unnamed>")+'"')
;throw e.mode=O,e}if("end"===s.type){const e=h(s);if(e!==Y)return e}
if("illegal"===s.type&&""===o)return s.index===t.length||(S+="\n"),1
;if(D>1e5&&D>3*s.index)throw Error("potential infinite loop, way more iterations than matches")
;return S+=o,o.length}const w=v(e)
;if(!w)throw P(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const x=W(w);let k="",O=s||x;const M={},A=new p.__emitter(p);(()=>{const e=[]
;for(let n=O;n!==w;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>A.openNode(e)))})();let S="",C=0,T=0,D=0,R=!1;try{
if(w.__emitTokens)w.__emitTokens(t,A);else{for(O.matcher.considerAll();;){
D++,R?R=!1:O.matcher.considerAll(),O.matcher.lastIndex=T
;const e=O.matcher.exec(t);if(!e)break;const n=N(t.substring(T,e.index),e)
;T=e.index+n}N(t.substring(T))}return A.finalize(),k=A.toHTML(),{language:e,
...
context:t.slice(T-100,T+100),mode:n.mode,resultSoFar:k},_emitter:A};if(r)return{
...
;if(v(n.language).supersetOf===e.language)return-1}return 0})),[r,o]=s,c=r
...
}),O("after:highlightElement",{el:e,result:s,text:a})}let N=!1;function w(){
if("loading"===document.readyState)return N||window.addEventListener("DOMContentLoaded",(()=>{
w()}),!1),void(N=!0);document.querySelectorAll(p.cssSelector).forEach(y)}
...
listLanguages:()=>Object.keys(a),getLanguage:v,registerAliases:x,
...
r=!1},t.safeMode=()=>{r=!0},t.versionString="11.11.1",t.regex={concat:b,
...
}},i={$pattern:me,keyword:_e,literal:he,built_in:we,"variable.language":Ne
...
className:"title.class",keywords:{_:[...fe,...Ee]}},N={variants:[{
match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[f],
illegal:/%/},w={
match:n.concat(/\b/,(v=[...ye,"super","import","await"].map((e=>e+"\\s*\\(")),
n.concat("(?!",v.join("|"),")")),t,n.lookahead(/\s*\(/)),
className:"title.function",relevance:0};var v;const x={
...
},{begin:n.concat(/:\s*/,/([*]|[a-zA-Z_$][a-zA-Z0-9_$]*)/)}]},e.METHOD_GUARD],
illegal:/#/}},grmr_bash:e=>{const n=e.regex,t={},a={begin:/\$\{/,end:/\}/,
...
},contains:[l,e.SHEBANG(),d,c,s,r,{match:/(\/[a-z._-]+)+/},o,{match:/\\"/},{
...
},b=[l,r,t,e.C_BLOCK_COMMENT_MODE,c,o],m={variants:[{begin:/=/,end:/;/},{
...
},p=[m,l,r,t,e.C_BLOCK_COMMENT_MODE,c,o],_={variants:[{begin:/=/,end:/;/},{
begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
...
relevance:0}],illegal:[/[;<']/,/BEGIN/]}},grmr_haxe:e=>{
const n="[a-zA-Z_$][a-zA-Z0-9_$]*";return{name:"Haxe",aliases:["hx"],keywords:{
...
relevance:0},{className:"variable",begin:"\\$"+n},{className:"meta",begin:/@:?/,
end:/\(|$/,excludeEnd:!0},{className:"meta",begin:"#",end:"$",keywords:{
keyword:"if else elseif end error"}},{className:"type",
begin:":[ \t]*(?=\\(|"+n+")",end:/[^A-Za-z0-9_ \t\->]/,excludeBegin:!0,
excludeEnd:!0,relevance:0},{className:"type",begin:":[ \t]*(?="+n+")",end:/\W/,
...
illegal:/\S/,contains:[e.TITLE_MODE]}],illegal:/<\//}},grmr_ini:e=>{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},ue,s]}},grmr_javascript:ve,
...
},e.C_LINE_COMMENT_MODE,l,r,o,s,e.C_NUMBER_MODE]},l]},{
...
const n=te(e),t=ce,a="[\\w-]+",i="("+a+"|@\\{"+a+"\\})",s=[],r=[],o=e=>({
className:"string",begin:"~?"+e+".*?"+e}),c=(e,n,t)=>({className:e,begin:n,
relevance:t}),l={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:ie.join(" ")},d={begin:"\\(",end:"\\)",contains:r,keywords:l,
relevance:0}
...
className:"selector-pseudo",begin:":(:)?("+re.join("|")+")"},{begin:/\(/,
...
match:n.concat(a,n.lookahead(":"),n.lookahead(/(?!::)/))},N={relevance:0,
...
scope:{3:"title.function.invoke"},contains:[N]};N.contains.push(w)
;const v=[y,E,e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE,e.HASH_COMMENT_MODE,d,g,h],x={
...
contains:["self",...v]},...v,{scope:"meta",variants:[{match:i},{match:s}]}]}
...
begin:/\?>/}]},{scope:"variable.language",match:/\$this\b/},r,w,E,{
...
contains:["self",x,r,E,e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE,e.HASH_COMMENT_MODE,d,g]
...
contains:[e.BACKSLASH_ESCAPE,s,o,r]},{begin:/([fF][rR]|[rR][fF]|[fF])"""/,
...
starts:{end:"$",keywords:s,contains:m}}];return c.unshift(o),{name:"Ruby",
...
keyword:"Self",built_in:o,type:c}},{className:"punctuation",begin:"->"},s]}},
grmr_scss:e=>{const n=te(e),t=re,a=se,i="@[a-z-]+",s={className:"variable",
...
className:{2:"keyword"}},s={match:b(/\./,m(...Ae)),relevance:0
},r=Ae.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Me).map(xe),...Oe)}]},c={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(Te),literal:Se},l=[i,s,o],g=[{
...
}),v=(e="")=>({begin:b(e,/"/),end:b(/"/,e),contains:[E(e),N(e)]}),x={
className:"string",
...
match:b(/@/,Fe)}],D={match:d(/\b[A-Z]/),relevance:0,contains:[{className:"type",
...
match:/\.\.\./,relevance:0},{match:b(/\s+&\s+/,d(ze)),relevance:0}]},R={
begin:/</,end:/>/,keywords:c,contains:[...a,...l,...T,u,D]};D.contains.push(R)
;const I={begin:/\(/,end:/\)/,relevance:0,keywords:c,contains:["self",{
match:b(Fe,/\s*:/),keywords:"_|0",relevance:0
},...a,A,...l,...g,...p,f,x,...C,...T,D]},L={begin:/</,end:/>/,
keywords:"repeat each",contains:[...a,D]},B={begin:/\(/,end:/\)/,keywords:c,
contains:[{begin:m(d(b(Fe,/\s*:/)),d(b(Fe,/\s+/,Fe,/\s*:/))),end:/:/,
relevance:0,contains:[{className:"keyword",match:/\b_\b/},{className:"params",
match:Fe}]},...a,...l,...p,f,x,...T,D,I],endsParent:!0,illegal:/["']/},$={
...
1:"keyword",3:"title"},contains:[D],keywords:[...Ce,...Se],end:/}/},j={
...
contains:[...a],relevance:0},A,...l,...g,...p,f,x,...C,...T,D,I]}},
grmr_typescript:e=>{
const n=e.regex,t=ve(e),a=me,i=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],s={
...
literal:he,built_in:we.concat(i),"variable.language":Ne},c={className:"meta",
...
begin:/[^\s,{}[\]]+/}]}),s={end:",",endsWithParent:!0,excludeEnd:!0,keywords:n,
relevance:0},r={begin:/\{/,end:/\}/,contains:[s],illegal:"\\n",relevance:0},o={
...
;return l.pop(),l.push(i),s.contains=l,{name:"YAML",case_insensitive:!0,
