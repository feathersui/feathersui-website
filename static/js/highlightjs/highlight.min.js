...
;[R,L,Z,$].forEach((e=>e(s,r))),e.compilerExtensions.forEach((e=>e(s,r))),
s.__beforeBegin=null,[D,I,B].forEach((e=>e(s,r))),s.isCompiled=!0;let l=null
...
;const i=N.case_insensitive?n[0].toLowerCase():n[0],s=(a=i,O.keywords[a]);if(s){
const[e,a]=s
...
let y={};function w(a,s){const o=s&&s[0];if(S+=a,null==o)return d(),0
...
;const x=W(N);let k="",O=s||x;const M={},A=new p.__emitter(p);(()=>{const e=[]
...
e[t]&&e[t](n)}))}Object.assign(t,{highlight:h,highlightAuto:E,highlightAll:N,
highlightElement:y,
...
}},i={$pattern:me,keyword:_e,literal:he,built_in:Ne,"variable.language":we
...
},contains:[c,e.SHEBANG(),d,l,s,r,{match:/(\/[a-z._-]+)+/},o,{match:/\\"/},{
...
},p=[m,c,r,t,e.C_BLOCK_COMMENT_MODE,l,o],_={variants:[{begin:/=/,end:/;/},{
begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
...
contains:[t,e.C_BLOCK_COMMENT_MODE,o,l,r,{begin:/\(/,end:/\)/,keywords:b,
relevance:0,contains:["self",t,e.C_BLOCK_COMMENT_MODE,o,l,r]}]
},r,t,e.C_BLOCK_COMMENT_MODE,c]};return{name:"C++",
...
const n=te(e),t=le,a="[\\w-]+",i="("+a+"|@\\{"+a+"\\})",s=[],r=[],o=e=>({
className:"string",begin:"~?"+e+".*?"+e}),l=(e,n,t)=>({className:e,begin:n,
relevance:t}),c={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:ie.join(" ")},d={begin:"\\(",end:"\\)",contains:r,keywords:c,
relevance:0}
...
starts:{end:"[;{}]",keywords:c,returnEnd:!0,contains:r,relevance:0}},p={
...
},{begin:/[$%@](?!")[^\s\w{=]|\$=/,relevance:0}],contains:[r]},l={
...
endsWithParent:!0}),s,{className:"string",contains:c,variants:[{
...
contains:[e.TITLE_MODE,r,l]},{begin:"-\\w\\b",relevance:0},{begin:"^__DATA__$",
...
scope:{3:"title.function.invoke"},contains:[w]};w.contains.push(N)
...
begin:/\?>/}]},{scope:"variable.language",match:/\$this\b/},r,N,E,{
...
contains:["self",s,u,l,e.HASH_COMMENT_MODE]}]};return r.contains=[l,u,s],{
...
keyword:"Self",built_in:o,type:l}},{className:"punctuation",begin:"->"},s]}},
...
},l,r,{scope:"variable",match:/@[a-z0-9][a-z0-9_]*/},{scope:"string",variants:[{
...
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Me).map(xe),...Oe)}]},l={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(Te),literal:Se},c=[i,s,o],g=[{
...
}),v=(e="")=>({begin:b(e,/"/),end:b(/"/,e),contains:[E(e),w(e)]}),x={
className:"string",
...
contains:[{begin:/\(/,end:/\)/,keywords:Ue,contains:[...p,f,x]}]}},{
...
;const t=[...c,...g,...p,f,x,...C];n.contains=[...t,{begin:/\(/,end:/\)/,
...
contains:[...a],relevance:0},A,...c,...g,...p,f,x,...C,...T,R,I]}},
grmr_typescript:e=>{
...
literal:he,built_in:Ne.concat(i),"variable.language":we},l={className:"meta",
...
t.contains=t.contains.concat([l,s,r,g]),
